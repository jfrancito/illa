...
<div class="be-content ventacotizar">
          ...
          <div class="panel-body">
                ...
                <div class="tab-container">
                  <ul class="nav nav-tabs">
                    <li class="active"><a href="#cotizar" data-toggle="tab">Estructura</a></li>
                  ...
                  <div class="tab-content">
                    ...
                    <div id="cotizar" class="tab-pane active cont">
                        <form method="POST" action="{{ url('/modificar-precotizacion/'.$idopcion.'/'.Hashids::encode(substr($precotizacion->id, -8))) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                                {{ csrf_field() }}
                           @include('evaluarrequerimiento.form.fcotizar')
                        </form>
                    </div>
                    
                    <div id="precotizar" class="tab-pane cont">
                      @include('evaluarrequerimiento.vista.data')
                    </div>
  ...
  @include('evaluarrequerimiento.modal.mcotizacion')
...
@section('script')
    ...
    <script src="{{ asset('public/js/venta/evaluarcotizacion.js?v='.$version) }}" type="text/javascript"></script>
