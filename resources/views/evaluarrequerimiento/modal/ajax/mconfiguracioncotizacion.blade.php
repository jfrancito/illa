...
@php
	...
	if(isset($swmodificar)){
		$disable = 'disabled';
		$vardisable = !$swmodificar;
	}
@endphp
<form method="POST" action="{{ url('/cotizar-evaluar-requerimiento/'.$idopcion.'/'.Hashids::encode(substr($cotizacion->id, -8))) }}" name='frmcotizarrequerimiento' id='frmcotizarrequerimiento'>
				...
				<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							<div class="form-group">
								<label class="col-sm-12 control-label labelleft negrita" >Codigo<span class="obligatorio">(*)</span> :</label>
								<div class="col-sm-12 abajocaja">
									<input type="text" name="codigo" id='codigo' class="form-control control input-sm codigo SOLONUMEROS" required value="@if(isset($codigo)) {{ $codigo }} @else {{ '00' }} @endif" maxlength="20" disabled> 
										@include(	'error.erroresvalidate', 
													[ 
														'id' => $errors->has('codigo')  , 
														'error' => $errors->first('codigo', ':message') , 
					...
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="form-group">
									<label class="col-sm-12 control-label text-left"><b>Descripcion <span class="obligatorio">(*)</span> </b>:</label>
									<div class="col-sm-12">
										<input type="text" name="servicio" id="servicio" class="form-control control input-sm" value="@if(isset($detalle)){{ $detalle->descripcion }} @endif">
									</div>
							</div>
						</div>
					</div>
