...
<div class="col-sm-2 col-sm-offset-10">
  ...
  <div class="botonesconfiglinea">
   ...
   {{--  <span>
      <a href="{{ url('imprimir-planeamiento/'.$idopcion.'/'.Hashids::encode(substr($cotizacion->id,-8))) }}" class="button  btn-information opciones brnimprimircotizacion" 
    ...
    <span>
     ...
     <span>
      <a href="{{ url('gestion-planeamiento/'.$idopcion) }}" class="button  btn-information opciones btnatras" 
        data_cotizacion_id = "{{$cotizacion->id}}"
       >
...
<div class='col-sm-12 listajax listaajaxdetallecotizar'>
  @include('planeamiento.ajax.alistadetallecotizacion')
</div>
