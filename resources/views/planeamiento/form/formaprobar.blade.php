...
<div class="form-group">
  <label class="col-sm-3 control-label">Nombre Proyecto:</label>
  <div class="col-sm-6">
  <input type="text" class="form-control control input-sm validarmayusculas" placeholder='NOMBRE PROYECTO' name="nombre_proyecto" id='nombre_proyecto' value="">
  </div>
</div>


<div class="form-group">
  <label class="col-sm-3 control-label">Descripcion de Aprobar<span class="obligatorio">(*)</span> :</label>
  <div class="col-sm-6">
