<div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="form-group">
              ...
              <div class="col-sm-12">
                  <input type="text" class="form-control control input-sm validarmayusculas" 
  ...
  <div class="col-xs-12">
    <p class="text-right">
      <button type="submit" class="btn btn-space btn-primary btnagregaranalisis"                  
                  data_planeamiento_id = "{{$cotizacion->id}}"
                  data_detalle_planeamiento_id = "{{$detallecotizacion->id}}" >Agregar</button>
    </p>
  </div>
</div>

<div class='col-sm-12 listajaxanalisis'>
  @include('planeamiento.ajax.alistadetalleanalizar')
</div>
