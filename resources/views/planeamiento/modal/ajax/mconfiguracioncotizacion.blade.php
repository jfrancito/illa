...
@endphp
<form method="POST" action="{{ url('/analizar-planeamiento/'.$idopcion.'/'.Hashids::encode(substr($cotizacion->id, -8))) }}" name='frmcotizarrequerimiento' id='frmcotizarrequerimiento'>
	{{ csrf_field() }}
