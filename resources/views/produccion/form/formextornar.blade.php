<div class="form-group">
  ...
  <div class="col-sm-6">
  <input type="text" disabled class="form-control control input-sm" value="{{ $cotizacion->nombre }}">
  </div>
</div>
<div class="form-group">
...
<div class="row xs-pt-15">
  ...
  <div class="col-xs-6">
    <p class="text-right">
      <a href="{{ url('/gestion-de-requerimiento/'.$idopcion) }}"><button type="button" class="btn btn-space btn-danger btncancelar">Cancelar</button></a>
