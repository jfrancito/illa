              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">{{ $titulo }}
                  <div class="tools tooltiptop">
                    ...
                    <a href="{{ url('/agregar-'.$url.'/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Produccion</span>
                      <span class="icon mdi mdi-plus-circle-o"></span>
                    </a>

                    <form method="POST" id='formpedido' class='opciones' action="{{ url('/emitir-'.$url.'/'.$idopcion) }}" 
                    style="display: inline-block;" >
                      {{ csrf_field() }}
                      <input type="hidden" id='pedido' name='pedido' >
                      <a href="#" class="tooltipcss" id='emitirrequerimiento' >
