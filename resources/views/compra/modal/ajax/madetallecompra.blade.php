<form method="POST" action="{{ url('/guardar-detalle-compra/'.$idopcion.'/'.Hashids::encode(substr($compra_id, -8))) }}">
			{{ csrf_field() }}
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
							...
							<input  type="text"
											...
											value="@if(isset($detallecompra)){{old('cantidad' ,$detallecompra->cantidad)}}@endif" 
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
							...
							<input  type="text"
											...
											value="@if(isset($detallecompra)){{old('preciounitario' ,$detallecompra->preciounitario)}}@endif" 
				...
				<div class="form-group">
					...
					<div class="col-sm-12 dflex">
						...
						<div class="be-checkbox has-success" style="display: block !important;">
							<input type="hidden" name="indigv" id='indigv' value="@if(isset($detallecompra)){{old('igv' ,$detallecompra->igv)}}@else {{ 0 }}@endif">
                          <input id="ckindigv" type="checkbox"  title="IGV" 
                          	@if(isset($detallecompra) && ($detallecompra->indigv==1))
                          		checked=""
                          	@endif
                          >
						...
						<input  type="text"
							...
							value="@if(isset($detallecompra)){{old('porcigv' ,$detallecompra->porcigv)}}@else {{ 0.0 }}@endif" 
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
							...
							<input  type="text" readonly 
											id="igv" name='igv' 
											value="@if(isset($detallecompra)){{old('igv' ,$detallecompra->igv)}}@else {{ 0.0 }}@endif" 
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
							...
							<input  type="text"  readonly 
											...
											value="@if(isset($detallecompra)){{old('subtotal' ,$detallecompra->subtotal)}}@endif" 
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
				<div class="form-group">
					...
					<div class="col-sm-12">
							...
							<input  type="text"
											id="total" name='total' 
											value="@if(isset($detallecompra)){{old('total' ,$detallecompra->total)}}@endif" 
											placeholder="Total"
											disabled="disabled"
...
@if(isset($ajax))
	<script type="text/javascript">
		$(document).ready(function(){
			...
			if(indigv==1){
				$('.compra #porcigv').prop('disabled', false); 
			}
			else{
				$('.compra #porcigv').prop('disabled', true); 
			}
			// buscar productos 
			$('.select3').select2({
