...
@section('section')
  ...
  <div class="be-content contenido listacompra">
    <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Lista de Compras
                  <div class="tools tooltiptop">

                    <a href="{{ url('/agregar-compras/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Compra</span>
                      <span class="icon mdi mdi-plus-circle-o"></span>
                    </a>                    
                    <a href="#" class="tooltipcss buscarlistacompra">
                ...
                <div class="panel-body">
                  ...
                  <div class='listatablacompras listajax'>
                    @include('compra.ajax.alistacompra')
                  </div>
                </div>
              </div>
            </div>
    ...
    @include('compra.modal.memitircompra')
  </div>
