          ...
          <div class="btn-group btn-hspace">
            ...
            <ul role="menu" class="dropdown-menu pull-right">
              <li @if($item->estado_id == '1CIX00000014') hidden @endif>
                <a href="{{ url('/modificar-compras/'.$idopcion.'/'.Hashids::encode(substr($item->id, -8))) }}">
                  Modificar
                </a>  
              </li>
              <li @if($item->estado_id != '1CIX00000003' or $item->montototal == 0) hidden @endif>
                <a href="#" class="emitircompra" data_idcompra = '{{Hashids::encode(substr($item->id, -8))}}'>
                  Emitir
                </a>  
              </li>
              <li @if($item->estado_id == '1CIX00000014') hidden @endif>
                <a href="{{ url('/extornar-compras/'.$idopcion.'/'.Hashids::encode(substr($item->id, -8))) }}">
                  Extornar
                </a>  
              </li>
              <li>                
