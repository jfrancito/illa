    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">Agregar Compra

            <span class="panel-subtitle">Crear un nuevo compra</span>
          </div>
          <div class="panel-body">
            <form method="POST" action="{{ url('/agregar-compras/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                  {{ csrf_field() }}
