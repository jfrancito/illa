...
<div class="be-content ventacotizar">
      ...
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">Produccion
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <span class="panel-subtitle">Nombre &nbsp;&nbsp;&nbsp;&nbsp;: <b>{{$cotizacion->nombre}}</b></span>
              </div>

              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <span class="panel-subtitle">Cantidad &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b>{{$cotizacion->cantidad}}</b></span>
              </div>

              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <span class="panel-subtitle">Descripcion &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{$cotizacion->descripcion}}</span>
              </div>



              {{-- <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <span class="panel-subtitle">Produccion : {{$cotizacion->lote}}</span>
              </div> --}}
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
          ...
          <div class="panel-body divventacotizar" >
              ...
              @include('cotizacion.form.fanalizar')
          </div>
        </div>
      </div>
    </div>
  ...
  @include('cotizacion.modal.magregarproducto')
  @include('cotizacion.modal.mcotizacion')
  @include('cotizacion.modal.memitirproduccion')
