          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Lista de Bienes Producidos
                  <div class="tools tooltiptop">

                    <a href="{{ url('/agregar-bien-producidos/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Bien Producido</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listatablaproductos listajax'>
                    @include('configuracion.ajax.alistabienproducido')
                  </div>
