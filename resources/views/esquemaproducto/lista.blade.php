...
@section('section')
  ...
  <div class="be-content contenido listaventa">
              ...
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Lista de Ordenes Ventas
                  <div class="tools tooltiptop">
                    ...
                    <a href="{{ url('/agregar-esquema-productos/'.$idopcion) }}" class="tooltipcss">
                      <span class="tooltiptext">Crear Esquema de Productos</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listatablaventas listajax'>
                    @include('esquemaproducto.ajax.alista')
                  </div>
                </div>
              </div>
            </div>
    ...
    @include('esquemaproducto.modal.memitirmodal')
  </div>
