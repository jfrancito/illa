      ...
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          ...
          <div class="panel-body">
            <form method="POST" action="{{ url('/generar-emitir-compras/'.$idopcion.'/'.Hashids::encode(substr($ordenventa->id, -8))) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                  {{ csrf_field() }}
                  <div class='formconsulta'>
                    @include('ordenventa.form.fcomprarordenventa')
                  </div>              
            </form>
          </div>
        </div>
