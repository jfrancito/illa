      ...
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          ...
          <div class="panel-body">
            ...
            <form method="POST" action="{{ url('/modificar-orden-venta-esquema/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                  {{ csrf_field() }}
                  <div class='formconsulta'>
                    @include('ordenventa.form.formulario',['swmodidicar'=>true])
                  </div>              
            </form>
          </div>
        </div>
