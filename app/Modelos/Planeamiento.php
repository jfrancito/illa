...
class Planeamiento extends Model
{
    ...
    public function Extorno(){
        return $this->belongsTo('App\Modelos\LogExtornar','idtabla','id')->whereTabla('planeamientos')->whereActivo(1);
    }


    public function Emision(){
        return $this->belongsTo('App\Modelos\LogEmitir','idtabla','id')->whereTabla('planeamientos')->whereActivo(1);
    }

    public function Aprobacion(){
        return $this->belongsTo('App\Modelos\LogAprobar','idtabla','id')->whereTabla('planeamientos')->whereActivo(1);
    }
