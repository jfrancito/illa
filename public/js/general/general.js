$(document).ready(function(){
    ...
    //INPUT MAYÚSCULAS
    function abrircargandomodal(mensaje,nivel=3) {
       ...
       //imagen que aparece mientras nuestro div es mostrado y da apariencia de cargando
        // imgCentro = "<div style='text-align:center;height:" + alto + "px;'><div style='margin-top:" + heightdivsito + "px;'><img style='width: 200px;' src='"+cadnivel+"public/img/gif/camion.gif'></div><div class='msjcargando'>" + mensaje + "</div></div>";
        imgCentro = "<div style='text-align:center;height:" + alto + "px;'><div style='margin-top:" + heightdivsito + "px;'><img style='width: 200px;' src='"+cadnivel+"public/img/gif/cargando1.gif'></div><div class='msjcargando'>" + mensaje + "</div></div>";
   ...
   //INPUT NUMERO DE CTA
    ...
    $('.sololectura').keydown(function(event){
         event.preventDefault();
    });
...
function abrircargando(mensaje,nivel=3) {
    //eliminamos si existe un div ya bloqueando
    cerrarcargando();
    cadnivel = '';
    for(i=0;i<nivel;i++){
...
function notifybien(titulo,mensaje){
    $.gritter.add({
            title: titulo,
            text: mensaje,
...
function notifyinf(titulo,mensaje){
    $.gritter.add({
            title: titulo,
            text: mensaje,
...
function notifyblack(titulo,mensaje){
    $.gritter.add({
            title: titulo,
            text: mensaje,
