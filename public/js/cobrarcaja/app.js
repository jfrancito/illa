$(document).ready(function(){
    ...
    $(".venta").on('click','.agregadetalle', function() {
        debugger;
    ...
    $(".venta").on('keyup','#preciounitario , #importe', function() {
    ...
    function CalcularSaldo()
    {
        ...
        var importe                    =   $(".venta #importe").val().replace(",","");
        var saldo                       =   $('.venta #saldo').val();
        var total                       =   $('.venta #total').val();
        if(importe>saldo){
            alerterrorajax("Importe debe ser menor o igual al saldo.");
            $('.venta #importe').val(saldo);
            return false;
        }
        // saldo = saldo - importe;
